...
function drop2() {
 ...
 function drop4() {
  ...
  if (remainingMangos === 0) {
    swal({
      title: `WHOOO!`,
      text: "Mulan Is Verry Happy! Thanks for collecting the Mangos!",
